import {SetNodeOperation, SlateOperation} from "../action/SlateOperation";
import {pathTransform} from "./pathTransformer";
import {Path} from "../Path";

export function setNodeTransformer(operation: SetNodeOperation, appliedOperation: SlateOperation, _: boolean): SetNodeOperation[] {
