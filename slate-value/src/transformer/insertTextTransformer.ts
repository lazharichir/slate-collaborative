import {InsertTextOperation, SlateOperation} from "../action/SlateOperation";
import {Path} from "../Path";
import {pathTransform} from "./pathTransformer";

export function insertTextTransformer(operation: InsertTextOperation, appliedOperation: SlateOperation, tieBreaker: boolean): InsertTextOperation[] {
